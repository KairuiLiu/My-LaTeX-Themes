...
\usepackage{xeCJK}
\setCJKmainfont{Noto Serif CJK SC} %中文字體main跟mono都需要哦，最後面的SC是簡體中文，也可以改成TC，不過SC的破字會比較少
\setCJKmonofont{Noto Serif CJK SC}
\usefonttheme{serif}

% meta-data
\title{UoA Beamer Presentation Theme}
\subtitle{Using \LaTeX\ to prepare slides}

\author{\href{mailto:kliu855@aucklanduni.ac.nz}{Liu Kairui}}
